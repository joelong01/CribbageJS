...
function getCardValueToMyCrib(card1, card2)
{
    ...
    return dropTable[card1, card2];

}

function getCardValueToYourCrib(card1, card2)
{
    ...
    for (var i = 0; i < list.length; i++)
    {
        ...
        else if (previousCard.Rank == thisCard.Rank) // pair
        {
            ...
            if (consecutive == 1 && pairs == 1 || consecutive == 2 && pairs == 2)
            {
                ...
                var newList = cardList[count - 1].splice(0);
            ...
            else if (consecutive == 1 && pairs == 2)
            {
                for (var k = 0; k < 2; k++)
                {
                    var newList = cardList[k].splice(0);
                    newList.pop(previousCard);
                    newList.push(thisCard);
                    cardList.push(newList);
                }
